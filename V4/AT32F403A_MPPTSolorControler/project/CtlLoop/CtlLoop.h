...
//V3
//#define CAL_VOUT_K	 0.9989f		//Vout矫正K值
//#define CAL_VOUT_B	 0.0348f
//#define CAL_VIN_K		 1.0017f		//Vin矫正K值
//#define CAL_VIN_B		-0.0812f		

#define CAL_VOUT_K	  0.9875f		//Vout矫正K值
#define CAL_VOUT_B	 -0.1314f
#define CAL_VIN_K		  0.9858f		//Vin矫正K值

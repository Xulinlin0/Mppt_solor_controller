...
void OLED_Init_GPIO(void)
{
  ...
  /* enable the led clock */
	...
	crm_periph_clock_enable(OLED_GPIO_CS_CRM_CLK, TRUE);
  ...
  gpio_init_struct.gpio_pins = OLED_RST_PIN | OLED_DC_PIN;
  gpio_init_struct.gpio_pull = GPIO_PULL_NONE;
  gpio_init(OLED_GPIO, &gpio_init_struct);
	
	gpio_init_struct.gpio_pins = OLED_CS_PIN;
	gpio_init(OLED_GPIO_CS, &gpio_init_struct);
	
	OLED_GPIO->scr = OLED_RST_PIN | OLED_DC_PIN;
	OLED_GPIO_CS->scr = OLED_CS_PIN;
}
